...
<skill id="command-creator" name="Command Creator" version="1.0">

  <overview>
    <purpose>
      Guide the creation of a new dubstack command source. Commands are
      slash-triggered shortcuts — simpler than skills, producing a single
      .md file at the configured output target.
    </purpose>
  ...
  <completion>
    <action>
      ...
      1. Location of the created command files
      2. Summary of the command type and purpose
      3. Next steps: build, test
    </action>

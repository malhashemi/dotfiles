...
PanelWindow {
    ...
    // Open and close the popup; called by the bar's clock/date widgets.
    function toggle() { root.isOpen = !root.isOpen }
    function openAt(x) { root.desiredLeft = x; root.isOpen = true }
    function toggleAt(x) { if (root.isOpen) root.isOpen = false; else { root.desiredLeft = x; root.isOpen = true } }
    ...
    // Horizontal position of the popup, set by openAt/toggleAt so it opens
    // under the clicked bar item.
    property real desiredLeft: 0

    margins { 
        top: root.currentTopMargin
        left: root.desiredLeft
    }
    ...
    component ActionIcon: Button {
        ...
        contentItem: Text { 
            text: parent.text; color: cPrimary; font.pixelSize: 18; 
    ...
    Item {
        ...
        ColumnLayout {
            ...
            Rectangle { Layout.fillWidth: true; implicitHeight: 1; color: cPrimary; opacity: 0.3 }
            ...
            RowLayout {
                ...
                Rectangle { Layout.fillHeight: true; implicitWidth: 1; color: cPrimary; opacity: 0.3 }
                    ...
                    GridLayout {
                        ...
                        Repeater {
                            ...
                            Rectangle {
                                ...
                                Layout.fillHeight: true
                                radius: width / 2 
                                color: model.isToday ? cPrimary : "transparent"
                                ...
                                Text {
                                    ...
                                    color: model.isToday ? cBg : cOnSurface
